...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DataCatalogPage.body'
        db.add_column(u'demo_datacatalogpage', 'body',
                      self.gf('wagtail.wagtailcore.fields.RichTextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'DataPriorityPage.body'
        db.add_column(u'demo_dataprioritypage', 'body',
                      self.gf('wagtail.wagtailcore.fields.RichTextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DataCatalogPage.body'
        db.delete_column(u'demo_datacatalogpage', 'body')

        # Deleting field 'DataPriorityPage.body'
        db.delete_column(u'demo_dataprioritypage', 'body')
