...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventPage.short_description'
        db.add_column(u'demo_eventpage', 'short_description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EventPage.short_description'
        db.delete_column(u'demo_eventpage', 'short_description')
