...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EnglishLinkBlockPlacement'
        db.create_table(u'demo_englishlinkblockplacement', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='linkblock_placements', to=orm['demo.EnglishHomePage'])),
            ('linkBlock', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['demo.LinkBlock'])),
        ))
        db.send_create_signal(u'demo', ['EnglishLinkBlockPlacement'])

        # Adding model 'SpanishLinkBlockPlacement'
        db.create_table(u'demo_spanishlinkblockplacement', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='linkblock_placements', to=orm['demo.SpanishHomePage'])),
            ('linkBlock', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['demo.LinkBlock'])),
        ))
        db.send_create_signal(u'demo', ['SpanishLinkBlockPlacement'])


    def backwards(self, orm):
        # Deleting model 'EnglishLinkBlockPlacement'
        db.delete_table(u'demo_englishlinkblockplacement')

        # Deleting model 'SpanishLinkBlockPlacement'
        db.delete_table(u'demo_spanishlinkblockplacement')
