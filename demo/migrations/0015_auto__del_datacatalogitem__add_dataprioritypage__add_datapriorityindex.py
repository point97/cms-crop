...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'DataPriorityPage'
        db.create_table(u'demo_dataprioritypage', (
            (u'datapriorityindex_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['demo.DataPriorityIndex'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'demo', ['DataPriorityPage'])

        # Adding model 'DataPriorityIndex'
        db.create_table(u'demo_datapriorityindex', (
        ...
        db.send_create_signal(u'demo', ['DataPriorityIndex'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'DataPriorityPage'
        db.delete_table(u'demo_dataprioritypage')

        # Deleting model 'DataPriorityIndex'
        db.delete_table(u'demo_datapriorityindex')
