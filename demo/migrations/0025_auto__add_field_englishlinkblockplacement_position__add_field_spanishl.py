...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EnglishLinkBlockPlacement.position'
        db.add_column(u'demo_englishlinkblockplacement', 'position',
                      self.gf('django.db.models.fields.CharField')(default='content-bottom', max_length=45),
                      keep_default=False)

        # Adding field 'SpanishLinkBlockPlacement.position'
        db.add_column(u'demo_spanishlinkblockplacement', 'position',
                      self.gf('django.db.models.fields.CharField')(default='content-bottom', max_length=45),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EnglishLinkBlockPlacement.position'
        db.delete_column(u'demo_englishlinkblockplacement', 'position')

        # Deleting field 'SpanishLinkBlockPlacement.position'
        db.delete_column(u'demo_spanishlinkblockplacement', 'position')
