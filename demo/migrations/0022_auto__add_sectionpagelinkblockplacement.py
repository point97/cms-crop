...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SectionPageLinkBlockPlacement'
        db.create_table(u'demo_sectionpagelinkblockplacement', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='linkblock_placements', to=orm['demo.SectionPage'])),
            ('linkBlock', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['demo.LinkBlock'])),
        ))
        db.send_create_signal(u'demo', ['SectionPageLinkBlockPlacement'])


    def backwards(self, orm):
        # Deleting model 'SectionPageLinkBlockPlacement'
        db.delete_table(u'demo_sectionpagelinkblockplacement')
