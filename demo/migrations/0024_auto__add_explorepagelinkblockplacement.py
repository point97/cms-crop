...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ExplorePageLinkBlockPlacement'
        db.create_table(u'demo_explorepagelinkblockplacement', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='linkblock_placements', to=orm['demo.ExploreSectionPage'])),
            ('linkBlock', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['demo.LinkBlock'])),
            ('position', self.gf('django.db.models.fields.CharField')(default='content-bottom', max_length=45)),
        ))
        db.send_create_signal(u'demo', ['ExplorePageLinkBlockPlacement'])


    def backwards(self, orm):
        # Deleting model 'ExplorePageLinkBlockPlacement'
        db.delete_table(u'demo_explorepagelinkblockplacement')
    ...
    models = {
        ...
        u'demo.explorepagelinkblockplacement': {
            'Meta': {'object_name': 'ExplorePageLinkBlockPlacement'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'linkBlock': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': u"orm['demo.LinkBlock']"}),
            'page': ('modelcluster.fields.ParentalKey', [], {'related_name': "'linkblock_placements'", 'to': u"orm['demo.ExploreSectionPage']"}),
            'position': ('django.db.models.fields.CharField', [], {'default': "'content-bottom'", 'max_length': '45'})
        },
        ...
        u'demo.genericcontentpage': {
            'Meta': {'object_name': 'GenericContentPage', '_ormbases': [u'demo.MultiLingualPage']},
        ...
        u'demo.sectionpagelinkblockplacement': {
            'Meta': {'object_name': 'SectionPageLinkBlockPlacement'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'linkBlock': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': u"orm['demo.LinkBlock']"}),
            'page': ('modelcluster.fields.ParentalKey', [], {'related_name': "'linkblock_placements'", 'to': u"orm['demo.SectionPage']"}),
            'position': ('django.db.models.fields.CharField', [], {'default': "'content-bottom'", 'max_length': '45'})
        },
