...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DataCatalogPage'
        db.create_table(u'demo_datacatalogpage', (
            (u'datacatalogindex_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['demo.DataCatalogIndex'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'demo', ['DataCatalogPage'])

        # Adding model 'DataCatalogIndex'
        db.create_table(u'demo_datacatalogindex', (
        ...
        db.send_create_signal(u'demo', ['DataCatalogIndex'])

        # Adding model 'DataCatalogItem'
        db.create_table(u'demo_datacatalogitem', (
            (u'multilingualpage_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['demo.MultiLingualPage'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'demo', ['DataCatalogItem'])


    def backwards(self, orm):
        # Deleting model 'DataCatalogPage'
        db.delete_table(u'demo_datacatalogpage')

        # Deleting model 'DataCatalogIndex'
        db.delete_table(u'demo_datacatalogindex')

        # Deleting model 'DataCatalogItem'
        db.delete_table(u'demo_datacatalogitem')
    ...
    models = {
        ...
        u'demo.datacatalogitem': {
            'Meta': {'object_name': 'DataCatalogItem', '_ormbases': [u'demo.MultiLingualPage']},
            u'multilingualpage_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['demo.MultiLingualPage']", 'unique': 'True', 'primary_key': 'True'})
        },
