...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MultiLingualPage'
        db.create_table(u'demo_multilingualpage', (
            (u'page_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['wagtailcore.Page'], unique=True, primary_key=True)),
            ('spanish_link', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['wagtailcore.Page'])),
        ))
        db.send_create_signal(u'demo', ['MultiLingualPage'])

        # Adding model 'LangRootPage'
        db.create_table(u'demo_langrootpage', (
            (u'page_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['wagtailcore.Page'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'demo', ['LangRootPage'])

        # Adding model 'EnglishHomePage'
        db.create_table(u'demo_englishhomepage', (
        ...
        db.send_create_signal(u'demo', ['EnglishHomePage'])

        # Adding model 'SpanishHomePage'
        db.create_table(u'demo_spanishhomepage', (
            (u'multilingualpage_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['demo.MultiLingualPage'], unique=True, primary_key=True)),
            ('body', self.gf('wagtail.wagtailcore.fields.RichTextField')(blank=True)),
        ))
        db.send_create_signal(u'demo', ['SpanishHomePage'])


    def backwards(self, orm):
        # Deleting model 'MultiLingualPage'
        db.delete_table(u'demo_multilingualpage')

        # Deleting model 'LangRootPage'
        db.delete_table(u'demo_langrootpage')

        # Deleting model 'EnglishHomePage'
        db.delete_table(u'demo_englishhomepage')

        # Deleting model 'SpanishHomePage'
        db.delete_table(u'demo_spanishhomepage')
