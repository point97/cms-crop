...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EnglishHomePageCarouselItem'
        db.create_table(u'demo_englishhomepagecarouselitem', (
            ...
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='carousel_items', to=orm['demo.EnglishHomePage'])),
        ))
        db.send_create_signal(u'demo', ['EnglishHomePageCarouselItem'])


    def backwards(self, orm):
        # Deleting model 'EnglishHomePageCarouselItem'
        db.delete_table(u'demo_englishhomepagecarouselitem')
