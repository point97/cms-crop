...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SectionPageLinkBlockPlacement.position'
        db.add_column(u'demo_sectionpagelinkblockplacement', 'position',
                      self.gf('django.db.models.fields.CharField')(default='content-bottom', max_length=45),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SectionPageLinkBlockPlacement.position'
        db.delete_column(u'demo_sectionpagelinkblockplacement', 'position')
