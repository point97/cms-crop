...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExploreTopic.default_topic'
        db.add_column(u'demo_exploretopic', 'default_topic',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExploreTopic.default_topic'
        db.delete_column(u'demo_exploretopic', 'default_topic')
