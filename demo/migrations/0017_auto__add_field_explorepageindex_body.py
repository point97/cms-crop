...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExplorePageIndex.body'
        db.add_column(u'demo_explorepageindex', 'body',
                      self.gf('wagtail.wagtailcore.fields.RichTextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExplorePageIndex.body'
        db.delete_column(u'demo_explorepageindex', 'body')
