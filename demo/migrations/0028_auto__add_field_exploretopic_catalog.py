...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExploreTopic.catalog'
        db.add_column(u'demo_exploretopic', 'catalog',
                      self.gf('jsonfield.fields.JSONField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExploreTopic.catalog'
        db.delete_column(u'demo_exploretopic', 'catalog')
    ...
    models = {
        ...
        u'demo.exploretopic': {
            ...
            'catalog': ('jsonfield.fields.JSONField', [], {'null': 'True', 'blank': 'True'}),
            'default_topic': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'image': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['wagtailimages.Image']"}),
            'long_description': ('wagtail.wagtailcore.fields.RichTextField', [], {'null': 'True', 'blank': 'True'}),
            'mp_id': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            u'multilingualpage_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['demo.MultiLingualPage']", 'unique': 'True', 'primary_key': 'True'}),
