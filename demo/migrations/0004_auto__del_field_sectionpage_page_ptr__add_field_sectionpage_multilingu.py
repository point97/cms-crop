...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SectionPage.page_ptr'
        db.delete_column(u'demo_sectionpage', u'page_ptr_id')

        # Adding field 'SectionPage.multilingualpage_ptr'
        db.add_column(u'demo_sectionpage', u'multilingualpage_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=0, to=orm['demo.MultiLingualPage'], unique=True, primary_key=True),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'SectionPage.page_ptr'
        raise RuntimeError("Cannot reverse this migration. 'SectionPage.page_ptr' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'SectionPage.page_ptr'
        db.add_column(u'demo_sectionpage', u'page_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['wagtailcore.Page'], unique=True, primary_key=True),
                      keep_default=False)

        # Deleting field 'SectionPage.multilingualpage_ptr'
        db.delete_column(u'demo_sectionpage', u'multilingualpage_ptr_id')
