...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ExploreTopic'
        db.create_table(u'demo_exploretopic', (
            ...
            ('long_description', self.gf('wagtail.wagtailcore.fields.RichTextField')(null=True, blank=True)),
        ...
        db.send_create_signal(u'demo', ['ExploreTopic'])

        # Adding field 'ExplorePageIndex.sidebar_title'
        db.add_column(u'demo_explorepageindex', 'sidebar_title',
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'ExploreTopic'
        db.delete_table(u'demo_exploretopic')

        # Deleting field 'ExplorePageIndex.sidebar_title'
        db.delete_column(u'demo_explorepageindex', 'sidebar_title')
