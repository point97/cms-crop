...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StandardPage.title_en'
        db.add_column(u'demo_standardpage', 'title_en',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'StandardPage.title_es'
        db.add_column(u'demo_standardpage', 'title_es',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'StandardPage.intro_en'
        db.add_column(u'demo_standardpage', 'intro_en',
                      self.gf('wagtail.wagtailcore.fields.RichTextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'StandardPage.intro_es'
        db.add_column(u'demo_standardpage', 'intro_es',
                      self.gf('wagtail.wagtailcore.fields.RichTextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'StandardPage.body_en'
        db.add_column(u'demo_standardpage', 'body_en',
                      self.gf('wagtail.wagtailcore.fields.RichTextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'StandardPage.body_es'
        db.add_column(u'demo_standardpage', 'body_es',
                      self.gf('wagtail.wagtailcore.fields.RichTextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StandardPage.title_en'
        db.delete_column(u'demo_standardpage', 'title_en')

        # Deleting field 'StandardPage.title_es'
        db.delete_column(u'demo_standardpage', 'title_es')

        # Deleting field 'StandardPage.intro_en'
        db.delete_column(u'demo_standardpage', 'intro_en')

        # Deleting field 'StandardPage.intro_es'
        db.delete_column(u'demo_standardpage', 'intro_es')

        # Deleting field 'StandardPage.body_en'
        db.delete_column(u'demo_standardpage', 'body_en')

        # Deleting field 'StandardPage.body_es'
        db.delete_column(u'demo_standardpage', 'body_es')
