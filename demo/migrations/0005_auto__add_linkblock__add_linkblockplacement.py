...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LinkBlock'
        db.create_table(u'demo_linkblock', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ('text', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'demo', ['LinkBlock'])

        # Adding model 'LinkBlockPlacement'
        db.create_table(u'demo_linkblockplacement', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'demo', ['LinkBlockPlacement'])


    def backwards(self, orm):
        # Deleting model 'LinkBlock'
        db.delete_table(u'demo_linkblock')

        # Deleting model 'LinkBlockPlacement'
        db.delete_table(u'demo_linkblockplacement')
    ...
    models = {
        ...
        u'demo.linkblockplacement': {
            'Meta': {'object_name': 'LinkBlockPlacement'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
