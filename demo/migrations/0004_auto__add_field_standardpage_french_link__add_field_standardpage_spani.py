...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StandardPage.french_link'
        db.add_column(u'demo_standardpage', 'french_link',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['wagtailcore.Page']),
                      keep_default=False)

        # Adding field 'StandardPage.spanish_link'
        db.add_column(u'demo_standardpage', 'spanish_link',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['wagtailcore.Page']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StandardPage.french_link'
        db.delete_column(u'demo_standardpage', 'french_link_id')

        # Deleting field 'StandardPage.spanish_link'
        db.delete_column(u'demo_standardpage', 'spanish_link_id')
    ...
    models = {
        ...
        u'demo.standardpage': {
            ...
            'body': ('wagtail.wagtailcore.fields.RichTextField', [], {'blank': 'True'}),
            'feed_image': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['wagtailimages.Image']"}),
            'french_link': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': u"orm['wagtailcore.Page']"}),
            'intro': ('wagtail.wagtailcore.fields.RichTextField', [], {'blank': 'True'}),
            u'page_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['wagtailcore.Page']", 'unique': 'True', 'primary_key': 'True'}),
