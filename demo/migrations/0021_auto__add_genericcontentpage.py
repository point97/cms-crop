...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GenericContentPage'
        db.create_table(u'demo_genericcontentpage', (
        ...
        db.send_create_signal(u'demo', ['GenericContentPage'])


    def backwards(self, orm):
        # Deleting model 'GenericContentPage'
        db.delete_table(u'demo_genericcontentpage')
