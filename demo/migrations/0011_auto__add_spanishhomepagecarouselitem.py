...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SpanishHomePageCarouselItem'
        db.create_table(u'demo_spanishhomepagecarouselitem', (
            ...
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='carousel_items', to=orm['demo.SpanishHomePage'])),
        ))
        db.send_create_signal(u'demo', ['SpanishHomePageCarouselItem'])


    def backwards(self, orm):
        # Deleting model 'SpanishHomePageCarouselItem'
        db.delete_table(u'demo_spanishhomepagecarouselitem')
